0010 REM "LCD CGRAM Character Generator"
...
0080 DIM B[8]
0090 B[0]=0x00,0x00,0x11,0x00,0x00,0x11,0x0E,0x00
0100 A=0:GOSUB 6800:REM "0) SMILE"
0110 B[0]=0x00,0x11,0x1B,0x15,0x11,0x0A,0x04,0x00
0120 A=1:GOSUB 6800:REM "1) HEART"
0130 B[0]=0x10,0x18,0x1C,0x1F,0x1C,0x18,0x10,0x00
0140 A=2:GOSUB 6800:REM "2) RIGHT"
0150 B[0]=0x01,0x03,0x07,0x1F,0x07,0x03,0x01,0x00
0160 A=3:GOSUB 6800:REM "3) LEFT"
0170 B[0]=0x15,0x0A,0x15,0x0A,0x15,0x0A,0x15,0x00
0180 A=4:GOSUB 6800:REM "4) CHECK"
0190 B[0]=0x00,0x0E,0x1F,0x1F,0x1F,0x0E,0x00,0x00
0200 A=5:GOSUB 6800:REM "5) CIRCLE"
0210 B[0]=0x1F,0x11,0x11,0x15,0x11,0x11,0x1F,0x00
0220 A=6:GOSUB 6800:REM "6) JAPAN"
0230 B[0]=0x00,0x00,0x11,0x00,0x0E,0x11,0x0E,0x00
0240 A=7:GOSUB 6800:REM "7) SPEAK"
0250 X=0:Y=0:GOSUB 6600
0260 @="\x80\x81\x82\x83\x84\x85\x86\x87"
0270 GOSUB 6700:REM "Print string"
0280 END
0290 :
5000 REM "============================================="
...
6708 D=@[Z]
6710 IF D==0 RETURN
6712 IF D>=0x0080 IF D<=0x008F D=D-0x0080
6714 GOSUB 6400:REM "Write data"
6716 Z=Z+1
6718 GOTO 6708
6720 :
