...
0080 X=0:Y=0:GOSUB 6600:REM "Locate"
0090 @="\xD7\xBD\xDE\xCD\xDE\xD8\xB0 \xCA\xDF\xB2 \xC3\xDE"
0100 GOSUB 6700:REM "Print string"
0110 X=2:Y=1:GOSUB 6600:REM "Locate"
0120 @="\xCD\xDE\xB1\xD2\xC0\xD9 \xCA\xAF\xB7\xDD\xB8\xDE\xEF"
0130 GOSUB 6700:REM "Print string"
0140 END
0150 :
5000 REM "============================================="
